...
#define DEFINE_CMD_FULL(longName, shortName, description, refRequired, paramInfo)                                                                                                                      \
    ...
    static ObScriptCommand(kObScriptCommand_##longName) =                                                                                                                                              \
      {#longName, #shortName, 0, 0, #description, refRequired, 0, (sizeof(paramInfo) / sizeof(ObScriptParam)), 0, paramInfo, Cmd_##longName##_Execute, Cmd_Default_Parse, NULL, 0, 0}
...
#define DEFINE_CMD_EVAL_FULL(longName, shortName, description, refRequired, paramInfo)                                                                                                                 \
    ...
    static ObScriptCommand(kObScriptCommand_##longName) =                                                                                                                                              \
      {#longName, #shortName, 0, 0, #description, refRequired, 0, (sizeof(paramInfo) / sizeof(ObScriptParam)), 0, paramInfo, Cmd_##longName##_Execute, Cmd_Default_Parse, Cmd_##longName##_Eval, 1, 0}
