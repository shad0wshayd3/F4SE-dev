...
static ObScriptParam kParams_TwoInts[2] = {{"int", kType_Integer, 0}, {"int", kType_Integer, 0}};

static ObScriptParam kParams_OneString[1] = {
  {"string", kType_String, 0},
};

static ObScriptParam kParams_TwoStrings[2] = {{"string", kType_String, 0}, {"string", kType_String, 0}};

static ObScriptParam kParams_OneFloat[1] = {{"float", kType_Float, 0}};

static ObScriptParam kParams_TwoFloats[2] = {{"float", kType_Float, 0}, {"float", kType_Float, 0}};

static ObScriptParam kParams_OneActorValue[1] = {{"Actor Value", kType_ActorValue, 0}};