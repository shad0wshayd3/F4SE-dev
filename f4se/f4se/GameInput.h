...
public:
    ...
    enum { kDeviceType_Keyboard = 0, kDeviceType_Mouse, kDeviceType_Gamepad, kDeviceType_Kinect };

    enum { kEventType_Button = 0, kEventType_MouseMove, kEventType_Char, kEventType_Thumbstick, kEventType_DeviceConnect, kEventType_Kinect, kEventType_Unk6 };
...
public:
    PlayerInputHandler(): BSInputEventUser(true), unk10(0), unk18(0), unk19(0), unk1A(0), unk1C(0), unk20(0), unk21(0), unk22(0), unk24(0), unk28(0), unk2C(0) {}
...
public:
    ...
    bool IsGamepadEnabled() { return gamepadHandler ? gamepadHandler->IsEnabled() : false; }
};
