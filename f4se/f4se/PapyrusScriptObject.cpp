...
void papyrusScriptObject::RegisterFuncs(VirtualMachine* vm) {
    vm->RegisterFunction(new NativeFunction1<VMObject, void, UInt32>("RegisterForKey", "ScriptObject", papyrusScriptObject::RegisterForKey, vm));

    vm->RegisterFunction(new NativeFunction1<VMObject, void, UInt32>("UnregisterForKey", "ScriptObject", papyrusScriptObject::UnregisterForKey, vm));

    vm->RegisterFunction(new NativeFunction1<VMObject, void, BSFixedString>("RegisterForControl", "ScriptObject", papyrusScriptObject::RegisterForControl, vm));

    vm->RegisterFunction(new NativeFunction1<VMObject, void, BSFixedString>("UnregisterForControl", "ScriptObject", papyrusScriptObject::UnregisterForControl, vm));

    vm->RegisterFunction(new NativeFunction2<VMObject, void, BSFixedString, BSFixedString>("RegisterForExternalEvent", "ScriptObject", papyrusScriptObject::RegisterForExternalEvent, vm));

    vm->RegisterFunction(new NativeFunction1<VMObject, void, BSFixedString>("UnregisterForExternalEvent", "ScriptObject", papyrusScriptObject::UnregisterForExternalEvent, vm));

    vm->RegisterFunction(new NativeFunction0<VMObject, void>("RegisterForCameraState", "ScriptObject", papyrusScriptObject::RegisterForCameraState, vm));

    vm->RegisterFunction(new NativeFunction0<VMObject, void>("UnregisterForCameraState", "ScriptObject", papyrusScriptObject::UnregisterForCameraState, vm));

    vm->RegisterFunction(new NativeFunction1<VMObject, void, VMVariable>("RegisterForFurnitureEvent", "ScriptObject", papyrusScriptObject::RegisterForFurnitureEvent, vm));

    vm->RegisterFunction(new NativeFunction1<VMObject, void, VMVariable>("UnregisterForFurnitureEvent", "ScriptObject", papyrusScriptObject::UnregisterForFurnitureEvent, vm));
}
