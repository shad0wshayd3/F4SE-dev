...
namespace Serialization {
    ...
    void SetRevertCallback(PluginHandle plugin, F4SESerializationInterface::EventCallback callback) { GetPluginInfo(plugin)->revert = callback; }

    void SetSaveCallback(PluginHandle plugin, F4SESerializationInterface::EventCallback callback) { GetPluginInfo(plugin)->save = callback; }

    void SetLoadCallback(PluginHandle plugin, F4SESerializationInterface::EventCallback callback) { GetPluginInfo(plugin)->load = callback; }

    void SetFormDeleteCallback(PluginHandle plugin, F4SESerializationInterface::FormDeleteCallback callback) { GetPluginInfo(plugin)->formDelete = callback; }
