...
// B0
class BSGFxShaderFXTarget: public BSGFxDisplayObject, public BSTEventSink<ApplyColorUpdateEvent> {
public:
    BSGFxShaderFXTarget() {}
    BSGFxShaderFXTarget(GFxValue* source):
        BSGFxDisplayObject(source),
        unk58(0),
        unk60(0),
        unk68(0),
        unk6C(0),
        ...
        unkA0(0),
        colorType(0),
        unkAC(0) {}                    //{ CALL_MEMBER_FN(this, Impl_ctor)(source); }
    virtual ~BSGFxShaderFXTarget();    // { CALL_MEMBER_FN(this, Impl_dtor)(); };

    virtual void Unk_01(void* unk1, void* unk2) { Impl_Fn1(unk1, unk2); };

    virtual EventResult ReceiveEvent(ApplyColorUpdateEvent* evn, void* dispatcher);

    enum ColorTypes { kColorUnk1 = 0, kColorUnk2, kColorNormal, kColorUnk3, kColorUnk4, kColorWarning, kColorUnk6, kColorUnk7 };
