...
LatentF4SEDelayFunctor::LatentF4SEDelayFunctor(UInt32 stackId): stackId_(stackId) {}

LatentF4SEDelayFunctor::LatentF4SEDelayFunctor(SerializationTag): stackId_(0) {}
...
void F4SEDelayFunctorQueue::Push(IF4SEDelayFunctor* func) {    // lock_
...
F4SEDelayFunctorWaitList::F4SEDelayFunctorWaitList(): lastTickTime_(GetPerfCounter()) {
    LARGE_INTEGER freq;
...
void F4SEDelayFunctorWaitList::Add(SInt32 delayMS, IF4SEDelayFunctor* func) {    // inLock_
