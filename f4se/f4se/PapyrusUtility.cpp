...
void papyrusUtility::RegisterFuncs(VirtualMachine* vm) {
    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, VMArray<VMVariable>, VMVariable>("VarToVarArray", "Utility", papyrusUtility::VarToVarArray, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, VMVariable, VMArray<VMVariable>>("VarArrayToVar", "Utility", papyrusUtility::VarArrayToVar, vm));
