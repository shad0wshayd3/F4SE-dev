...
public:
    ...
    enum { kFlag_Dynamic = (1 << 0), kFlag_Unknown = (1 << 1) };
...
public:
    ...
    enum { kFlagCalculateFromAllLevelsLTPCLevel = 1 << 0, kFlagCalculateForEachItemInCount = 1 << 1 };
...
public:
    ...
    enum CompareOperators { kCompareOp_Equal = 0, kCompareOp_NotEqual, kCompareOp_Greater, kCompareOp_GreaterEqual, kCompareOp_Less, kCompareOp_LessEqual };
    ...
    class Evaluator {
    public:
        Evaluator(TESForm* a1, TESForm* a2) { CALL_MEMBER_FN(this, ctor)(a1, a2, 0); }
