...
bool GFxValue::GetBool(void) const {
    ...
    case kType_UInt:
        return data.u32 != 0;
    default:
        HALT("GFxValue::GetBool: bad type");
        return false;
    }
}
...
double GFxValue::GetNumber(void) const {
    switch (GetType()) {
    case kType_Int:
        return (double)data.s32;
    case kType_UInt:
        return (double)data.u32;
    case kType_Number:
        return data.number;
    case kType_Bool:
        return data.boolean ? 1 : 0;
    default:
        HALT("GFxValue::GetNumber: bad type");
        return 0;
    }
}
...
SInt32 GFxValue::GetInt(void) const {
    ...
    case kType_Int:
        return data.s32;
    case kType_UInt:
        return (SInt32)data.u32;
    case kType_Number:
        return (SInt32)data.number;
    case kType_Bool:
        return data.boolean ? 1 : 0;
    default:
        HALT("GFxValue::GetInt: bad type");
        return 0;
    }
}
...
UInt32 GFxValue::GetUInt(void) const {
    switch (GetType()) {
    case kType_Int:
        return (UInt32)data.s32;
    case kType_UInt:
        return data.u32;
    case kType_Number:
        return (UInt32)data.number;
    case kType_Bool:
        return data.boolean ? 1 : 0;
    default:
        HALT("GFxValue::GetUInt: bad type");
        return 0;
    }
}
