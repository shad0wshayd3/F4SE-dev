...
public:
    ...
    Data* unk38;    // 38
    enum Flags { kFlags_Playable = 1, kFlags_RemappableIndex = 2, kFlags_ExtendedLUT = 4 };
    UInt32 flags;    // 40
    UInt32 unk44;    // 44
};
...
public:
    ...
    enum { kTypeMisc = 0, kTypeFace, kTypeEyes, kTypeHair, kTypeFacialHair, kTypeScar, kTypeBrows, kType7, kType8, kTypeHeadRear, kNumTypes };
    UInt32 type;    // 74
...
public:
    ...
    public:
        ...
        enum { kWeaponTarget_Offset = 0x000, kArmorTarget_Offset = 0x100, kActorTarget_Offset = 0x200 };

        // Used by Papyrus to specify the particular operator
        enum { kOperator_Set = 0, kOperator_Add = 1, kOperator_Mult_Add = 2, kOperator_And = 3, kOperator_Or = 4, kOperator_Rem = 5 };
    ...
    public:
        ...
        public:
            ...
            enum { kTargetType_None = 0, kTargetType_Armor = 0x1D, kTargetType_Furniture = 0x2A, kTargetType_Weapon = 0x2B, kTargetType_Actor = 0x2D };
...
public:
    ...
    enum { kFlag_NeverResets = 1, kFlag_Workshop = 8 };
...
public:
    ...
    bool IsCompleted() { return ((flags >> 1) & 1); }
