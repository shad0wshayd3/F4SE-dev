...
public:
    ...
    virtual UInt64* GetReturnType(UInt64* dst) {
        *dst = m_retnType;
        return dst;
    }
    virtual UInt64 GetNumParams() { return m_params.realNumParams; }
    virtual UInt64 GetParam(UInt32 idx, BSFixedString* outName, UInt64* outType) { return CALL_MEMBER_FN(&m_params, GetParam)(idx, outName, outType); }
    ...
    virtual void Unk_0E() {}
    virtual UInt32 Invoke(void* arg0, void* arg1, VirtualMachine* arg2, VMState* arg3) { return CALL_MEMBER_FN(this, Impl_Invoke)(arg0, arg1, arg2, arg3); }
    ...
    virtual bool GetParamName(UInt32 idx, BSFixedString* out) { return CALL_MEMBER_FN(this, Impl_GetParamName)(idx, out); }
...
public:
    NativeFunction(const char* fnName, const char* className, bool isStatic, UInt32 numParams) { CALL_MEMBER_FN(this, Impl_ctor)(fnName, className, isStatic, numParams); }
