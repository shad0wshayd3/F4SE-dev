...
void papyrusInstanceData::RegisterFuncs(VirtualMachine* vm) {
    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, Owner>("GetAttackDamage", "InstanceData", papyrusInstanceData::GetAttackDamage, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, UInt32>("SetAttackDamage", "InstanceData", papyrusInstanceData::SetAttackDamage, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, VMArray<DamageTypeInfo>, Owner>("GetDamageTypes", "InstanceData", papyrusInstanceData::GetDamageTypes, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, VMArray<DamageTypeInfo>>("SetDamageTypes", "InstanceData", papyrusInstanceData::SetDamageTypes, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, Owner>("GetAmmoCapacity", "InstanceData", papyrusInstanceData::GetAmmoCapacity, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, UInt32>("SetAmmoCapacity", "InstanceData", papyrusInstanceData::SetAmmoCapacity, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, TESAmmo*, Owner>("GetAmmo", "InstanceData", papyrusInstanceData::GetAmmo, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, TESAmmo*>("SetAmmo", "InstanceData", papyrusInstanceData::SetAmmo, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, TESLevItem*, Owner>("GetAddAmmoList", "InstanceData", papyrusInstanceData::GetAddAmmoList, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, TESLevItem*>("SetAddAmmoList", "InstanceData", papyrusInstanceData::SetAddAmmoList, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, Owner>("GetAccuracyBonus", "InstanceData", papyrusInstanceData::GetAccuracyBonus, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, UInt32>("SetAccuracyBonus", "InstanceData", papyrusInstanceData::SetAccuracyBonus, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetActionPointCost", "InstanceData", papyrusInstanceData::GetActionPointCost, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetActionPointCost", "InstanceData", papyrusInstanceData::SetActionPointCost, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetAttackDelay", "InstanceData", papyrusInstanceData::GetAttackDelay, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetAttackDelay", "InstanceData", papyrusInstanceData::SetAttackDelay, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetOutOfRangeMultiplier", "InstanceData", papyrusInstanceData::GetOutOfRangeMultiplier, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetOutOfRangeMultiplier", "InstanceData", papyrusInstanceData::SetOutOfRangeMultiplier, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetReloadSpeed", "InstanceData", papyrusInstanceData::GetReloadSpeed, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetReloadSpeed", "InstanceData", papyrusInstanceData::SetReloadSpeed, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetReach", "InstanceData", papyrusInstanceData::GetReach, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetReach", "InstanceData", papyrusInstanceData::SetReach, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetMinRange", "InstanceData", papyrusInstanceData::GetMinRange, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetMinRange", "InstanceData", papyrusInstanceData::SetMinRange, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetMaxRange", "InstanceData", papyrusInstanceData::GetMaxRange, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetMaxRange", "InstanceData", papyrusInstanceData::SetMaxRange, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetSpeed", "InstanceData", papyrusInstanceData::GetSpeed, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetSpeed", "InstanceData", papyrusInstanceData::SetSpeed, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, Owner>("GetStagger", "InstanceData", papyrusInstanceData::GetStagger, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, UInt32>("SetStagger", "InstanceData", papyrusInstanceData::SetStagger, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, ActorValueInfo*, Owner>("GetSkill", "InstanceData", papyrusInstanceData::GetSkill, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, ActorValueInfo*>("SetSkill", "InstanceData", papyrusInstanceData::SetSkill, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, ActorValueInfo*, Owner>("GetResist", "InstanceData", papyrusInstanceData::GetResist, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, ActorValueInfo*>("SetResist", "InstanceData", papyrusInstanceData::SetResist, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetCritMultiplier", "InstanceData", papyrusInstanceData::GetCritMultiplier, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetCritMultiplier", "InstanceData", papyrusInstanceData::SetCritMultiplier, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetCritChargeBonus", "InstanceData", papyrusInstanceData::GetCritChargeBonus, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetCritChargeBonus", "InstanceData", papyrusInstanceData::SetCritChargeBonus, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, BGSProjectile*, Owner>("GetProjectileOverride", "InstanceData", papyrusInstanceData::GetProjectileOverride, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, BGSProjectile*>("SetProjectileOverride", "InstanceData", papyrusInstanceData::SetProjectileOverride, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, Owner>("GetNumProjectiles", "InstanceData", papyrusInstanceData::GetNumProjectiles, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, UInt32>("SetNumProjectiles", "InstanceData", papyrusInstanceData::SetNumProjectiles, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetSightedTransition", "InstanceData", papyrusInstanceData::GetSightedTransition, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetSightedTransition", "InstanceData", papyrusInstanceData::SetSightedTransition, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, bool, Owner, UInt32>("GetFlag", "InstanceData", papyrusInstanceData::GetFlag, vm));

    vm->RegisterFunction(new NativeFunction3<StaticFunctionTag, void, Owner, UInt32, bool>("SetFlag", "InstanceData", papyrusInstanceData::SetFlag, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, Owner>("GetArmorHealth", "InstanceData", papyrusInstanceData::GetArmorHealth, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, UInt32>("SetArmorHealth", "InstanceData", papyrusInstanceData::SetArmorHealth, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, Owner>("GetArmorRating", "InstanceData", papyrusInstanceData::GetArmorRating, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, UInt32>("SetArmorRating", "InstanceData", papyrusInstanceData::SetArmorRating, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, float, Owner>("GetWeight", "InstanceData", papyrusInstanceData::GetWeight, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, float>("SetWeight", "InstanceData", papyrusInstanceData::SetWeight, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, Owner>("GetGoldValue", "InstanceData", papyrusInstanceData::GetGoldValue, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, UInt32>("SetGoldValue", "InstanceData", papyrusInstanceData::SetGoldValue, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, VMArray<BGSKeyword*>, Owner>("GetKeywords", "InstanceData", papyrusInstanceData::GetKeywords, vm));

    vm->RegisterFunction(new NativeFunction2<StaticFunctionTag, void, Owner, VMArray<BGSKeyword*>>("SetKeywords", "InstanceData", papyrusInstanceData::SetKeywords, vm));
}
