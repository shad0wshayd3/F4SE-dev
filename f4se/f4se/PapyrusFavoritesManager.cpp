...
void papyrusFavoritesManager::RegisterFuncs(VirtualMachine* vm) {
    ...
    vm->RegisterFunction(new LatentNativeFunction0<StaticFunctionTag, VMArray<TESForm*>>("GetTaggedForms", "FavoritesManager", papyrusFavoritesManager::GetTaggedForms, vm));

    vm->RegisterFunction(new LatentNativeFunction1<StaticFunctionTag, void, VMArray<TESForm*>>("AddTaggedForms", "FavoritesManager", papyrusFavoritesManager::AddTaggedForms, vm));

    vm->RegisterFunction(new LatentNativeFunction1<StaticFunctionTag, void, VMArray<TESForm*>>("RemoveTaggedForms", "FavoritesManager", papyrusFavoritesManager::RemoveTaggedForms, vm));

    vm->RegisterFunction(new LatentNativeFunction1<StaticFunctionTag, bool, TESForm*>("IsTaggedForm", "FavoritesManager", papyrusFavoritesManager::IsTaggedForm, vm));

    vm->RegisterFunction(new LatentNativeFunction0<StaticFunctionTag, VMArray<TESForm*>>("GetFavorites", "FavoritesManager", papyrusFavoritesManager::GetFavorites, vm));

    vm->RegisterFunction(new LatentNativeFunction1<StaticFunctionTag, void, VMArray<TESForm*>>("SetFavorites", "FavoritesManager", papyrusFavoritesManager::SetFavorites, vm));
