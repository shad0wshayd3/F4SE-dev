...
public:
    ...
    UInt32 GetRefCount() const { return m_uiRefCount & kMask_RefCount; }
...
public:
    ...
    struct LoadedData {
        ...
        enum { kFlag_PhysicsInitialized = 1 };
...
public:
    ...
    enum ActorFlags { kFlag_Teammate = (1 << 26) };
    ...
    struct MiddleProcess {
        ...
        struct Data08 {
            ...
            enum { kDirtyHeadParts = 0x04, kDirtyGender = 0x20 };
            UInt32 unk490;    // 490
            UInt16 unk494;    // 494
