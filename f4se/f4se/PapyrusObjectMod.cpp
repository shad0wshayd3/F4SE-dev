...
namespace papyrusObjectMod {
    ...
    VMArray<PropertyModifier> GetPropertyModifiers(BGSMod::Attachment::Mod* thisMod) {
        ...
        for (UInt32 i = 0; i < thisMod->modContainer.dataSize / sizeof(BGSMod::Container::Data); i++) {
            ...
            case BGSMod::Container::Data::kOpFlag_Add_Int: {
                ...
                switch (data->op) {
                case BGSMod::Container::Data::kOpFlag_Set_Bool:
                    op = BGSMod::Container::kOperator_Set;
                    break;
                case BGSMod::Container::Data::kOpFlag_Or_Bool:
                    op = BGSMod::Container::kOperator_Or;
                    break;
                case BGSMod::Container::Data::kOpFlag_And_Bool:
                    op = BGSMod::Container::kOperator_And;
                    break;
                case BGSMod::Container::Data::kOpFlag_Set_Enum:
                    op = BGSMod::Container::kOperator_Set;
                    break;
                case BGSMod::Container::Data::kOpFlag_Set_Int:
                    ...
                    break;
                case BGSMod::Container::Data::kOpFlag_Add_Int:
                    op = BGSMod::Container::kOperator_Add;
                    break;
                }
            } break;
            case BGSMod::Container::Data::kOpFlag_Mul_Add_Float:
                //case BGSMod::Container::Data::kOpFlag_Mul_Add_Int: // Yes, mult int is treated the same as float
                {
                    ...
                    switch (data->op) {
                    case BGSMod::Container::Data::kOpFlag_Mul_Add_Float:
                        op = BGSMod::Container::kOperator_Mult_Add;
                        break;
            ...
            case BGSMod::Container::Data::kOpFlag_Rem_Form: {
                ...
                case BGSMod::Container::Data::kOpFlag_Add_Form:
                    ...
                    break;
                case BGSMod::Container::Data::kOpFlag_Rem_Form:
                    op = BGSMod::Container::kOperator_Rem;
                    break;
                }
            } break;
    ...
    UInt32 GetMaxRank(BGSMod::Attachment::Mod* thisMod) { return thisMod ? thisMod->maxRank : 0; }
    ...
    UInt32 GetPriority(BGSMod::Attachment::Mod* thisMod) { return thisMod ? thisMod->priority : 0; }
...
void papyrusObjectMod::RegisterFuncs(VirtualMachine* vm) {
    vm->RegisterFunction(new NativeFunction0<BGSMod::Attachment::Mod, VMArray<PropertyModifier>>("GetPropertyModifiers", "ObjectMod", papyrusObjectMod::GetPropertyModifiers, vm));

    vm->RegisterFunction(new NativeFunction0<BGSMod::Attachment::Mod, UInt32>("GetMaxRank", "ObjectMod", papyrusObjectMod::GetMaxRank, vm));

    vm->RegisterFunction(new NativeFunction1<BGSMod::Attachment::Mod, void, UInt32>("SetMaxRank", "ObjectMod", papyrusObjectMod::SetMaxRank, vm));

    vm->RegisterFunction(new NativeFunction0<BGSMod::Attachment::Mod, UInt32>("GetPriority", "ObjectMod", papyrusObjectMod::GetPriority, vm));

    vm->RegisterFunction(new NativeFunction1<BGSMod::Attachment::Mod, void, UInt32>("SetPriority", "ObjectMod", papyrusObjectMod::SetPriority, vm));

    vm->RegisterFunction(new NativeFunction0<BGSMod::Attachment::Mod, TESObjectMISC*>("GetLooseMod", "ObjectMod", papyrusObjectMod::GetLooseMod, vm));
}
