...
public:
    ...
    CLASS_NAME(const char* fnName, const char* className, CallbackType callback, VirtualMachine* vm): NativeFunction(fnName, className, IsStaticType<T_Base>::value, NUM_PARAMS) {
        // store callback
