...
void papyrusForm::RegisterFuncs(VirtualMachine* vm) {
    vm->RegisterFunction(new NativeFunction0<TESForm, BSFixedString>("GetName", "Form", papyrusForm::GetName, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, BSFixedString>("SetName", "Form", papyrusForm::SetName, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, BSFixedString>("GetDescription", "Form", papyrusForm::GetDescription, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, float>("GetWeight", "Form", papyrusForm::GetWeight, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, float>("SetWeight", "Form", papyrusForm::SetWeight, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, UInt32>("SetGoldValue", "Form", papyrusForm::SetGoldValue, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, VMArray<BGSKeyword*>>("GetKeywords", "Form", papyrusForm::GetKeywords, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, bool>("HasWorldModel", "Form", papyrusForm::HasWorldModel, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, BSFixedString>("GetWorldModelPath", "Form", papyrusForm::GetWorldModelPath, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, BSFixedString>("SetWorldModelPath", "Form", papyrusForm::SetWorldModelPath, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, BSFixedString>("GetIconPath", "Form", papyrusForm::GetIconPath, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, BSFixedString>("SetIconPath", "Form", papyrusForm::SetIconPath, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, BSFixedString>("GetMessageIconPath", "Form", papyrusForm::GetMessageIconPath, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, BSFixedString>("SetMessageIconPath", "Form", papyrusForm::SetMessageIconPath, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, EnchantmentItem*>("GetEnchantment", "Form", papyrusForm::GetEnchantment, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, EnchantmentItem*>("SetEnchantment", "Form", papyrusForm::SetEnchantment, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, UInt32>("GetEnchantmentValue", "Form", papyrusForm::GetEnchantmentValue, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, UInt32>("SetEnchantmentValue", "Form", papyrusForm::SetEnchantmentValue, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, BGSEquipSlot*>("GetEquipType", "Form", papyrusForm::GetEquipType, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, BGSEquipSlot*>("SetEquipType", "Form", papyrusForm::SetEquipType, vm));

    vm->RegisterFunction(new NativeFunction0<TESForm, TESRace*>("GetRaceForm", "Form", papyrusForm::GetRaceForm, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, TESRace*>("SetRaceForm", "Form", papyrusForm::SetRaceForm, vm));

    // Slot Mask
    vm->RegisterFunction(new NativeFunction0<TESForm, UInt32>("GetSlotMask", "Form", papyrusForm::GetSlotMask, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, void, UInt32>("SetSlotMask", "Form", papyrusForm::SetSlotMask, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, UInt32, UInt32>("AddSlotToMask", "Form", papyrusForm::AddSlotToMask, vm));

    vm->RegisterFunction(new NativeFunction1<TESForm, UInt32, UInt32>("RemoveSlotFromMask", "Form", papyrusForm::RemoveSlotFromMask, vm));

    vm->RegisterFunction(new NativeFunction1<StaticFunctionTag, UInt32, UInt32>("GetMaskForSlot", "Form", papyrusForm::GetMaskForSlot, vm));
}
