...
template<>
void PackValue<void>(VMValue* dst, void* src, VirtualMachine* registry);
template<>
void PackValue<UInt32>(VMValue* dst, UInt32* src, VirtualMachine* registry);
template<>
void PackValue<SInt32>(VMValue* dst, SInt32* src, VirtualMachine* registry);
template<>
