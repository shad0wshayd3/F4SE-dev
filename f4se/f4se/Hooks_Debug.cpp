...
typedef BOOL(__stdcall* _MiniDumpWriteDump)(HANDLE hProcess,
                                            DWORD ProcessId,
                                            HANDLE hFile,
    ...
    if (false) {
        ...
        if (s_dbgHelpDLL && s_dbgHelpWriteDump) {
            ...
            sprintf_s(s_crashDumpPath,
                      sizeof(s_crashDumpPath),
                      "%s\\My Games\\Fallout4\\F4SE\\Crashdumps\\%04d-%02d-%02d_%02d.%02d.%02d.dmp",
                      myDocumentsPath,
                      s_launchTime.wYear,
                      s_launchTime.wMonth,
                      s_launchTime.wDay,
                      s_launchTime.wHour,
                      s_launchTime.wMinute,
                      s_launchTime.wSecond);
